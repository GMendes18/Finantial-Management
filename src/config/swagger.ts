...
const options: swaggerJsdoc.Options = {
  definition: {
      ...
      schemas: {
        ...
        Category: {
          ...
          properties: {
            ...
            keywords: { type: 'array', items: { type: 'string' }, example: ['ifood', 'restaurante', 'mercado'] },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' },
          },
        },
        ...
        Investment: {
          ...
          properties: {
            ...
            purchasePrice: { type: 'number', example: 150.50 },
    ...
    tags: [
      ...
      { name: 'Exchange', description: 'Cotações de câmbio em tempo real' },
      { name: 'Investments', description: 'Gerenciamento de investimentos e portfolio' },
      { name: 'Insights', description: 'Insights financeiros com IA' },
    ],
  },
